...
const Canvas: React.FC = () => {
  ...
  const SIBLING_SPACING = 20; // Spacing between immediate siblings
  const GROUP_SPACING = 60;   // Spacing between groups (cousins/subtrees)
  ...
  const calculateNodePositions = useCallback((): { nodes: PositionedNode[], connections: Connection[] } => {
    ...
    if (currentConfig.tree.nodes.length === 0) {
